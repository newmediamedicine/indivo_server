...
<xsl:if test="indivodoc:amountOrdered"><xsl:if test="indivodoc:amountOrdered/value"><Field name="amountOrdered_value"><xsl:value-of select="indivodoc:amountOrdered/value"/></Field></xsl:if><xsl:if test="indivodoc:amountOrdered/textValue"><Field name="amountOrdered_textValue"><xsl:value-of select="indivodoc:amountOrdered/textValue"/></Field></xsl:if><xsl:if test="indivodoc:amountOrdered/unit"><Field name="amountOrdered_unit_text"><xsl:value-of select="indivodoc:amountOrdered/unit/text()"/></Field><xsl:if test="indivodoc:amountOrdered/unit/@type"><Field name="amountOrdered_unit_type"><xsl:value-of select="indivodoc:amountOrdered/unit/@type"/></Field></xsl:if><xsl:if test="indivodoc:amountOrdered/unit/@value"><Field name="amountOrdered_unit_value"><xsl:value-of select="indivodoc:amountOrdered/unit/@value"/></Field></xsl:if><xsl:if test="indivodoc:amountOrdered/unit/@abbrev"><Field name="amountOrdered_unit_abbrev"><xsl:value-of select="indivodoc:amountOrdered/unit/@abbrev"/></Field></xsl:if></xsl:if></xsl:if>
