...
<xsl:if test="indivodoc:result/value"><Field name="result_value"><xsl:value-of select="indivodoc:result/value"/></Field></xsl:if><xsl:if test="indivodoc:result/textValue"><Field name="result_textValue"><xsl:value-of select="indivodoc:result/textValue"/></Field></xsl:if><xsl:if test="indivodoc:result/unit"><Field name="result_unit_text"><xsl:value-of select="indivodoc:result/unit/text()"/></Field><xsl:if test="indivodoc:result/unit/@type"><Field name="result_unit_type"><xsl:value-of select="indivodoc:result/unit/@type"/></Field></xsl:if><xsl:if test="indivodoc:result/unit/@value"><Field name="result_unit_value"><xsl:value-of select="indivodoc:result/unit/@value"/></Field></xsl:if><xsl:if test="indivodoc:result/unit/@abbrev"><Field name="result_unit_abbrev"><xsl:value-of select="indivodoc:result/unit/@abbrev"/></Field></xsl:if></xsl:if>
