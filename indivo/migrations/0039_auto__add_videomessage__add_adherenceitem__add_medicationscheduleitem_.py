...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_videomessage', (
            ...
            ('fileId', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('storageType', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateRecorded', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateSent', self.gf('django.db.models.fields.DateField')(blank=True)),
        ))
        ...
        db.create_table('indivo_adherenceitem', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('reportedBy', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateReported', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('recurrenceIndex', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('adherence', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('nonadherenceReason', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        db.create_table('indivo_medicationscheduleitem', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('scheduledBy', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateScheduled', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateStart', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateEnd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('recurrenceRule', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('instructions', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dose_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('dose_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dose_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dose_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dose_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dose_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        # Adding model 'CollaboRhythmVitalSign'
        db.create_table('indivo_collaborhythmvitalsign', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('measuredBy', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dateMeasuredStart', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateMeasuredEnd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('technique', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('result_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('result_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('result_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('result_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('result_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('result_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('indivo', ['CollaboRhythmVitalSign'])
        ...
        db.create_table('indivo_medicationadministration', (
            ...
            ('reportedBy', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateReported', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateAdministered', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('amountAdministered_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('amountAdministered_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountAdministered_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountAdministered_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountAdministered_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountAdministered_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountRemaining_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('amountRemaining_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountRemaining_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountRemaining_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountRemaining_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountRemaining_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CollaboRhythmVitalSign'
        db.delete_table('indivo_collaborhythmvitalsign')
    ...
    models = {
        ...
        'indivo.adherenceitem': {
            ...
            'dateReported': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
        ...
        'indivo.collaborhythmvitalsign': {
            ...
            'dateMeasuredEnd': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'dateMeasuredStart': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'indivo.healthactionschedule': {
            ...
            'dateScheduled': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'dateStart': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'name_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'recurrenceRule': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'indivo.medicationadministration': {
            ...
            'dateAdministered': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'dateReported': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'name_abbrev': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'indivo.medicationfill': {
            ...
            'dateFilled': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'fillSequenceNumber': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'filledBy': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'instructions': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'indivo.medicationorder': {
            ...
            'dateExpires': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'dateOrdered': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'indivo.videomessage': {
            ...
            'dateRecorded': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'dateSent': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'fileId': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'storageType': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
