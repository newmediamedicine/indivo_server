...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Wellness'
        db.create_table('indivo_wellness', (
            ...
            ('dateReported', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('numberOfStepsTaken', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('numberOfHoursSlept', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('numberOfTimesAwakened', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('indivo', ['Wellness'])


    def backwards(self, orm):
        # Deleting model 'Wellness'
        db.delete_table('indivo_wellness')
    ...
    models = {
        ...
        'indivo.examplemodel': {
            'Meta': {'object_name': 'ExampleModel', '_ormbases': ['indivo.Fact']},
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'name_abbrev': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'indivo.wellness': {
            'Meta': {'object_name': 'Wellness', '_ormbases': ['indivo.Fact']},
            'dateReported': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'measurementDate': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'numberOfHoursSlept': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'numberOfStepsTaken': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'numberOfTimesAwakened': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'reportedBy': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        }
    }
