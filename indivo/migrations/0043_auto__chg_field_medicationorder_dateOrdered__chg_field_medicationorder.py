...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicationOrder.dateOrdered'
        db.alter_column('indivo_medicationorder', 'dateOrdered', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'MedicationOrder.dateExpires'
        db.alter_column('indivo_medicationorder', 'dateExpires', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'MedicationOrder.dateOrdered'
        db.alter_column('indivo_medicationorder', 'dateOrdered', self.gf('django.db.models.fields.DateField')())
