...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_medicationfill', (
            ...
            ('filledBy', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateFilled', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('fillSequenceNumber', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('lotNumber', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('refillsRemaining', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('ndc_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ndc_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ndc_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ndc_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountFilled_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('amountFilled_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountFilled_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountFilled_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountFilled_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountFilled_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
