...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.sent_read_at'
        db.add_column('indivo_message', 'sent_read_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Message.sent_archived_at'
        db.add_column('indivo_message', 'sent_archived_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.sent_read_at'
        db.delete_column('indivo_message', 'sent_read_at')

        # Deleting field 'Message.sent_archived_at'
        db.delete_column('indivo_message', 'sent_archived_at')
