...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_medicationorder', (
            ...
            ('orderType', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('orderedBy', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dateOrdered', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('dateExpires', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('indication', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('refills', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('substitutionPermitted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ...
            ('amountOrdered_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=10, blank=True)),
            ('amountOrdered_unit_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountOrdered_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountOrdered_unit_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountOrdered_unit_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('amountOrdered_textValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
