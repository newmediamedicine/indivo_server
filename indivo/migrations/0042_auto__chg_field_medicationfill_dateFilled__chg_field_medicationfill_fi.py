...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicationFill.dateFilled'
        db.alter_column('indivo_medicationfill', 'dateFilled', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'MedicationFill.filledBy'
        db.alter_column('indivo_medicationfill', 'filledBy', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MedicationOrder.dateExpires'
        db.alter_column('indivo_medicationorder', 'dateExpires', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MedicationFill.dateFilled'
        raise RuntimeError("Cannot reverse this migration. 'MedicationFill.dateFilled' and its values cannot be restored.")

        # Changing field 'MedicationFill.filledBy'
        db.alter_column('indivo_medicationfill', 'filledBy', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # User chose to not deal with backwards NULL issues for 'MedicationOrder.dateExpires'
        raise RuntimeError("Cannot reverse this migration. 'MedicationOrder.dateExpires' and its values cannot be restored.")
