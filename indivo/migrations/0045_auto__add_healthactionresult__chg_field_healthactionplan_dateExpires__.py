...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_healthactionresult', (
            ...
            ('planType', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('reportedBy', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dateReported', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('indivo', ['HealthActionResult'])


        # Changing field 'HealthActionPlan.dateExpires'
        db.alter_column('indivo_healthactionplan', 'dateExpires', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HealthActionPlan.datePlanned'
        db.alter_column('indivo_healthactionplan', 'datePlanned', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'HealthActionPlan.instructions'
        db.alter_column('indivo_healthactionplan', 'instructions', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'HealthActionResult'
        db.delete_table('indivo_healthactionresult')


        # Changing field 'HealthActionPlan.dateExpires'
        db.alter_column('indivo_healthactionplan', 'dateExpires', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HealthActionPlan.datePlanned'
        db.alter_column('indivo_healthactionplan', 'datePlanned', self.gf('django.db.models.fields.DateField')())

        # Changing field 'HealthActionPlan.instructions'
        db.alter_column('indivo_healthactionplan', 'instructions', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'indivo.healthactionplan': {
            ...
            'datePlanned': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'indivo.healthactionresult': {
            ...
            'actions': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'dateReported': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'name_abbrev': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'planType': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'reportedBy': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
