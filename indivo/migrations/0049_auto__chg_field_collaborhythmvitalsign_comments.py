...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollaboRhythmVitalSign.comments'
        db.alter_column('indivo_collaborhythmvitalsign', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'CollaboRhythmVitalSign.comments'
        db.alter_column('indivo_collaborhythmvitalsign', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
